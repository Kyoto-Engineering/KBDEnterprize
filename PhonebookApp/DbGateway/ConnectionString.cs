 ...
 public   class ConnectionString
    {
     ...
     public string DBConn = @"Data Source=tcp:KyotoServer,49172;Initial Catalog=KBDEnterpriseDecember;User=sa;Password=SystemAdministrator;Persist Security Info=True;";
